...
- Find a test image to use (it does not have to be related to your campus space for this exercise) and download it to your computer. Rename the file according to our naming conventions (all lower case and dashes instead of spaces). The name should help you remember what the image is (keep in mind you'll have lots of images to keep track of eventually).
