...
- Find a test image to use (it doesn't have to be related to your campus space for this exercise) and download it to your computer. Rename the file according to our naming conventions (all lower case and dashes instead of spaces). The name should help you remember what the image is (keep in mind you'll have lots of images to keep track of eventually).
...
- Notice that the GitHub page for your file (like [the Mesa Visa one](https://github.com/unm-campus-histories/spaces/blob/master/docs/essays/mesa-vista-hall.md)) makes your Markdown look nice (with headers and bold and so on) but doesn't display images.
