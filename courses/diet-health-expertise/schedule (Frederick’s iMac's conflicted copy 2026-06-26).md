...
Remember all readings are in the Zotero library. To access them, you need to be logged into Zotero.org and visit [our group library](https://www.zotero.org/groups/642043/diet-health-expertise-unm/library). If you can't see the PDFs, you are either 1) not logged it, or 2) you never requested to join the library. Instructions are on the [syllabus home page](index)
%}
