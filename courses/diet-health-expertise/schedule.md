...
- What general ideas did you find most interesting?
- Pick out a quote (a sentence or two) that represents an idea you were surprised to find in a text about food from 2000 years ago.
- Use a specific quote/example from Galen's text that shows how diet fit into medical understandings of disease.
- How would you characterize how Galen tried to establish his expertise in this text? Does it remind you of any modern diet gurus? Would you have trusted him?
"%}


## Thu 7/2: Medieval Medicine and Premodern Diet
...
- Answer the following questions, but (unless you are the first one) relate your ideas to at least one other post (which could be right before yours or a different one). 
...
You may use AI to get oriented, but do not let it do the comparison for you. Before asking AI, spend a few minutes with the title page, preface/introduction, table of contents, and several sampled pages so you have your own first impression. Then ask AI for a basic overview of the two texts you chose: what each author seems to argue, what audience each text addresses, and what kind of dietary authority each author projects. Treat that answer as a rough second opinion, not as reliable interpretation.
