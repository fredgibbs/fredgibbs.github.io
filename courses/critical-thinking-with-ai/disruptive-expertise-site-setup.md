...
repository-url: https://github.com/amaranth-unm/disruptive-expertise
site-url: https://amaranth-unm.github.io/disruptive-expertise/
---
...
So, we use a feature of GitHub to allow _everyone_ to make their own copy of _{{page.site-name}}_ and edit that without fear of breaking anything. When you're done and you want to publish those changes on the live site, you can easily do that. This guide describes the process of setting up your own copy of _{{page.site-name}}_. 


## Create a GitHub account
- First, you need a free GitHub account for your repository.
...
## Fork the {{page.site-name}} repository
...
- Go to the [{{page.site-name}} repository]({{page.repository-url}}), and click the `Fork` button near the upper right corner (don't click the number). It's just below the top nav icons.
...
## Enable your website
You now have a "local" copy of the repository, which is all files that make the website work. Now, let's enable your own working copy of the  _{{page.site-name}}_ site. This is ables you to see how your essay looks as a webpage online (instead of just code that you're editing).  
