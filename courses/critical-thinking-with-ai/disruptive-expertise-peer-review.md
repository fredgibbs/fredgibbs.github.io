...
Open your classmate's page and read it all the way through---even if quickly---before writing anything. Keep the [Disruptive Expertise Guidelines](disruptive-expertise-guide) open in another tab so you can refer back to what the assignment requires.
...
- Are there clear section headings that help a reader navigate?
- Does the overall layout look polished and complete, or does it feel like a rough draft?
