...
title: "Divine Power and Statecraft — the Chronicle, Bede, al-Biruni, Machiavelli"
image_slides: true
---
<!-- ========== TITLE ========== -->
...
<div class="reveal-block unpack fragment" markdown="1">
...
<div class="reveal-block historical fragment" markdown="1">
...
"William Raleigh was elected Bishop of Norwich on 10th April. That horrible race of men known as the Tartars... laid waste Hungary and the neighboring territories. On 18th June Eleanor, queen of England, gave birth to her eldest son Edward." <span class="cite">a typical chronicle entry for 1239, quoted in Popkin, p. 43</span>
...
<div class="reveal-block historical fragment fade-in-then-out compact" data-fragment-index="3" markdown="1">
...
<img src="images/paschal-table-annals-detail.jpg" alt="Enlarged strip of the paschal table showing year rows 956 to 963, with a gold box around three historical notes added in the right margin">
<figcaption markdown="span">
The margin, enlarged · an annal being born
<em>Against the row for <strong>DCCCCLVIII</strong>: <i>Liutolfus Ottonis regis filius in Italia migravit</i> --- Otto the Great's son Liudolf died in Italy --- then two more obits. <strong>Liudolf actually died in September 957</strong>, one row up. All that ruled precision, and the annalist is still a year out.<br>(Cod. Sang. 459, p. 21. e-codices, CC BY-NC 4.0.)</em>
</figcaption>
</figure>
</section>
...
<img src="images/lindisfarne-stone-raiders.jpg" alt="One face of a carved sandstone grave marker: seven armed figures in a row raising swords and axes">
<img src="images/lindisfarne-stone-judgement.jpg" alt="The other face of the same stone: a cross flanked by sun and moon, with raised praying hands and kneeling figures below">
</div>
<figcaption markdown="span">
The raid, or the end of the world · <strong>the same stone, both faces</strong> · Lindisfarne, 1st quarter of the 9th century
<em>Left: seven men with raised swords and axes. Right: a cross between sun and moon, hands lifted in prayer. It is called <strong>both</strong> the Viking raider stone <strong>and</strong> the Doomsday stone --- and with a Last Judgement on the back, we cannot tell whether the front shows raiders or the end of the world. <i>The object everyone cites for 793 may not be about 793.</i><br>(Lindisfarne Priory, English Heritage, inv. 81077057. Photos Schillerwein, CC0.)</em>
</figcaption>
</figure>
</section>
...
"A. 786."  ·  "A. 807. 808."  ·  "A. 810. 811." <span class="cite">complete entries, *Anglo-Saxon Chronicle* (Giles trans.; other editions fill some of these from other manuscripts)</span>
...
<div class="takehome fragment" data-fragment-index="3" markdown="1">
...
<div class="reveal-block historical compact fragment" data-fragment-index="0" markdown="1">
...
<div class="reveal-block argument compact fragment" data-fragment-index="1" markdown="1">
...
<figure class="pair">
<div class="pair-images">
<img src="images/asc-msa-parker.jpg" alt="The first page of the Parker Chronicle, manuscript A, in plain Anglo-Saxon minuscule with a large plain initial">
<img src="images/asc-mse-peterborough.jpg" alt="The first page of the Peterborough Chronicle, manuscript E, in a later twelfth-century hand with a decorated initial">
</div>
<figcaption markdown="span">
...
<div class="takehome fragment" data-fragment-index="1" markdown="1">
...
"For if history relates good things of good men, the attentive hearer is excited to imitate that which is good; or if it recounts evil things of wicked persons... the devout hearer or reader, shunning that which is hurtful and wrong, is the more earnestly fired to perform those things which he knows to be good." <span class="cite">Bede, *Ecclesiastical History*, Preface</span>
{: .quote.fragment data-fragment-index="0"}
...
"For it was impossible that the martyr, who had left no water remaining in the river, should desire it on the top of the hill, **unless he thought it fitting**." <span class="cite">Bede, *Ecclesiastical History* I.7</span>
...
<div class="reveal-block argument fragment fade-in-then-out compact" data-fragment-index="3" markdown="1">
...
<section class="image-slide" data-background="#0d1412" markdown="1">
<figure class="portrait">
<img src="images/bede-hatton-43-f129r.jpg" alt="Manuscript page of Bede in Latin with a boxed addition in Old English written in the lower margin">
<figcaption markdown="span">
Bede caught being honest · Bodleian MS Hatton 43, fol. 129r
<em>Book IV.24. Bede gives Cædmon's divinely granted poem in Latin prose, then stops to say so: <strong>"This is the sense but not the order of the words as he sang them."</strong> So he <i>does</i> flag his paraphrasing --- just not at the council. And the boxed lines at the foot: a later scribe putting the Hymn back in Old English.<br>(Bodleian Libraries, Oxford, MS Hatton 43, fol. 129r. CC BY-SA 4.0.)</em>
</figcaption>
</figure>
</section>
...
<div class="takehome compact fragment" data-fragment-index="1" markdown="1">
...
"No one will deny that in questions of historic authenticity **hearsay does not equal eyewitness**... Written tradition is one of the species of hearsay --- we might almost say the most preferable. How could we know the history of nations but for *the everlasting monuments of the pen*?" <span class="cite">al-Biruni, preface to the *Kitab al-Hind* (Sachau trans.)</span>
{: .quote.fragment data-fragment-index="0"}
...
"The tradition regarding an event **that in itself does not contradict either logical or physical laws** will invariably depend for its character as true or false upon the character of the reporters." <span class="cite">al-Biruni, *Kitab al-Hind*, preface</span>
{: .quote.fragment data-fragment-index="0"}
...
<section class="image-slide" data-background="#0d1412" markdown="1">
<figure class="landscape">
<img src="images/mahmud-ghazna-india.jpg" alt="Persian miniature of an armoured army with drums and banners storming a walled fortress whose defenders shoot arrows from the battlements">
<figcaption markdown="span">
The patron · Mahmud of Ghazna storming a fortress
<em>The enterprise al-Biruni rode behind --- and he says so in the same preface: Mahmud <i>"utterly ruined the prosperity of the country... by which the Hindus became like atoms of dust scattered in all directions,"</i> who now hold <i>"the most inveterate aversion towards all Muslims."</i> <strong>He names his own position, then asks you to trust his sources anyway.</strong><br>(Rashīd al-Dīn, c. 1314 --- an imagining, not a witness. Public domain.)</em>
</figcaption>
</figure>
</section>
...
**Choice A --- dismiss.** The Middle Ages "possessed good writers of contemporary narrative," but they "were careless and impatient of older fact. They became content to be deceived, to live in a twilight of fiction." <span class="cite">Lord Acton, 1895, quoted in Popkin, pp. 40--41</span>
...
<div class="reveal-block historical fragment fade-in-then-out compact" data-fragment-index="4" markdown="1">
...
<div class="takehome fragment" data-fragment-index="5" markdown="1">
...
<div class="reveal-block historical fragment" data-fragment-index="0" markdown="1">
...
"A wise man ought always to follow the paths beaten by great men, and to imitate those who have been supreme, so that **if his ability does not equal theirs, at least it will savour of it**... like the clever archers who... take aim much higher than the mark." <span class="cite">Machiavelli, *The Prince*, ch. 6 (Marriott trans.)</span>
{: .quote.fragment data-fragment-index="0"}
...
"Moses, Cyrus, Romulus, Theseus, and such like are the most excellent examples. And **although one may not discuss Moses**, he having been a mere executor of the will of God, yet he ought to be admired..." <span class="cite">Machiavelli, *The Prince*, ch. 6</span>
{: .quote.fragment data-fragment-index="0"}
