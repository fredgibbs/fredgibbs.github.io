...
title: "Enlightenment Progress, part one — where the idea came from"
image_slides: true
---
<!-- ========== COLD OPEN 01: TIME UNVEILING TRUTH ========== -->
<section class="image-slide" data-background="#0d1412" markdown="1">
<figure class="landscape">
<img src="images/detroy-time-unveiling-truth-1733.jpg" alt="An allegorical painting: a winged, bearded figure of Time with a scythe draws a veil back from a luminous woman in white seated with her foot on a globe, while a hooded figure shrinks away clutching masks and a group with a lion looks on from the left">
<figcaption markdown="span">
<i>Time Unveiling Truth</i> · Jean-François de Troy, 1733
<em>Winged Time draws back the veil; Truth sits with her foot on the globe; Falsehood recoils on the right, clutching her masks.<br>(National Gallery, London, NG6454. Public domain.)</em>
</figcaption>
</figure>
</section>
...
<img src="images/detroy-time-unveiling-truth-1733.jpg" alt="The allegory, reduced: Time drawing a veil from Truth while Falsehood turns away">
...
Making History • HIST 1105 • Week 4 · part one
{: .eyebrow}
...
"This image's head was of fine gold, his breast and his arms of silver, his belly and his thighs of brass, His legs of iron, his feet part of iron and part of clay." <span class="cite">Daniel 2:32–33, King James Version</span>
...
"there was a more fortunate age and probably there will be one again; in the middle, in our time, you see the confluence of wretches and ignominy." <span class="cite">Petrarch, *Epistolae metricae* III.33, trans. Theodor E. Mommsen, *Medieval and Renaissance Studies* (Cornell, 1959), pp. 127–128</span>
{: .quote.compact.fragment data-fragment-index="0"}
...
<img src="images/machiavelli-santi-di-tito.jpg" alt="Portrait of Niccolò Machiavelli in black and red robes against a dark ground, faintly smiling">
<figcaption markdown="span">
Where we left off · Machiavelli, last week's source
<em>He and Guicciardini wrote histories with no divine plan in them --- human causes only, two centuries before Voltaire.<br>(Santi di Tito, Palazzo Vecchio, Florence. Public domain.)</em>
</figcaption>
</figure>
</section>
...
"having made a distinction and division... into Three Parts, or we would rather call them ages, from the second birth of these arts up to the century wherein we live, by reason of that very manifest difference that is seen between one and another of them." <span class="cite">Vasari, *Lives*, Preface to the Second Part, trans. Gaston du C. de Vere (1912–14)</span>
{: .quote.compact.fragment data-fragment-index="0"}
...
"As the 'moderns' began to prevail in this debate, they opened the way to a new vision of the meaning of time in which the future, with its possibilities for further achievement, loomed larger than the past." <span class="cite">Popkin, *From Herodotus to H-Net*, p. 62</span>
{: .quote.compact.fragment data-fragment-index="0"}
...
<img src="images/perrault-lallemand-portrait.jpg" alt="Portrait of Charles Perrault seated in a library in a black robe and long dark wig, one hand resting on a classical marble bust">
<img src="images/boileau-rigaud-portrait.jpg" alt="Portrait of Nicolas Boileau in a long dark wig and brown robe, seated at a desk with a quill in his hand over an open book">
</div>
<figcaption markdown="span">
Two sides of one quarrel · <strong>Perrault</strong> (left) and <strong>Boileau</strong> (right)
<em>January 1687: Perrault's poem tells the Académie française that his own century has beaten antiquity, and Boileau objects on the spot. <strong>Boileau was the king's own historiographer.</strong><br>(Left: Philippe Lallemand after Charles Le Brun, Château de Versailles. Right: workshop of Hyacinthe Rigaud, 1704. Both public domain.)</em>
</figcaption>
</figure>
</section>
...
"For some authors, this put the value of studying history in question: if previous ages had been thoroughly benighted, what could their experience teach the present?" <span class="cite">Popkin, *From Herodotus to H-Net*, p. 62</span>
{: .quote.fragment data-fragment-index="0"}
...
Bede's history has a guaranteed meaning: however far the world has fallen since Eden, it is still going somewhere, because God is taking it there. Remove that and the direction has to be argued for from scratch. **Kant's secret plan of Nature is built to fill the hole that opens here.**
</div>
</section>
