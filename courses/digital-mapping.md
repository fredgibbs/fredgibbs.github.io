...
The course explores the technologies, tools, and workflows that can help collect, connect, and present online interpretations of the spaces around us. Throughout the week, we'll dicuss the theoretical and practical challenges of deep mapping (producing rich, interactive maps with multiple layers of information). Woven into our discussions will be numerous technical tutorials that will allow us to tell map-based stories about Albuquerque's fascinating past. We'll move from creating simple maps with Google Maps/Earth to creating your own custom, interactive maps online with various open source tools like QGIS and Open Street Map that leverage the power of open data from local and national repositories to provide new perspectives on the built environment. We'll also use various mobile apps for data collection, online exhibit software, historical (physical and digital) materials at the Center for Southwest Research. Along the way we'll cover the various data formats used by different tools and how to move between them, allowing you to craft the most efficient workflow for your mapping purposes.
