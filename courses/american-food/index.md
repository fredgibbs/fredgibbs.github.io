...
While the history of food in the U.S. runs throughout the course, the main goal is to see how much fun we can have exploring different perspectives on how we use food as means of self-expression. **The history is really a means to an end: using the history of food to think more critically about meanings of food in the present.**
...
Not having actual class meetings deprives us of some collegial conversation, but it presents new freedoms as well. There isn't much to do most days except do the reading, think about it, and take a short quiz or write a brief reading reflection. There are a few slightly longer essays that give you the chance to apply the readings more directly and a final reflection to show off what you've learned from the course as a whole.
