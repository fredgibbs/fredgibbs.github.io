...
Reading Guide: We’ve been reading about language by which foods and supplements are labeled and the kind of laws they have to follow. While “organic” is not necessarily a health claim per se, but it clearly speaks to nature of what we consider to be "healthy" food. **In this article, don’t worry about all the sociological theory stuff, especially at the beginning.** Activity Systems Theory (whatever that is) is not our primary concern. Focus on the history of the organic movement and *the discourse of organics* (the way people define it for their own purposes and give it meaning). This is of course meant to complement our discussion about nutrition discourse. What have been some problems with "organic" as a label? Who has defined it? How can we explain (in part) the rise of organics? Why are "inputs" so crucial to certification? How is organic certification different from the problems with labeling we've recently discussed?
