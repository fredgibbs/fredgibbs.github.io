...
{% include figure.html class="full" src="/images/qgis/rumsey.png" caption="Historic maps + GIS = better historical insight" %}
...
{% include figure.html class="icon right" src="/images/qgis/add-raster-icon.png" %}
...
{% include figure.html class="icon right" src="/images/qgis/add-points-icon.png" %}
...
{% include figure.html class="icon right" src="/images/qgis/yellow-gear-icon.png" %}
...
{% include figure.html class="icon right" src="/images/qgis/green-arrow-icon.png" %}
