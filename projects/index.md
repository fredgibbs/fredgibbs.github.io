...
You can check out the [latest version of Xanthan](https://github.com/amaranth-unm/xanthan) and use it as a template for a new project. [A brief set of slides](http://fredgibbs.net/presentations/ghi/) provides more motivation and detail.


### UNM Campus Histories
When walking around campus, it’s easy to accept that the space around us just is, or is as it should be. But the history of the campus tells a different story. Reflecting on the history of the space around us helps us to become more attune to the power of spatial relationships and to become more conscious consumers and shapers of the environments we inhabit. See our research from the [Center for Southwest Research](https://elibrary.unm.edu/cswr/) at our [UNM Campus History website](http://amaranth-unm.github.io/campus-history/).
...
Our work came to life on a [website on the National Historic Sites on the Santa Fe Trail](https://historic-trails.unm.edu/).
